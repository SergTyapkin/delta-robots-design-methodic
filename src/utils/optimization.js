...
export const Real = function(low, high){
  return new _Real(low, high);
}
...
export const Integer = function(low, high){
  return new _Integer(low, high)
}
 ...
 */
function _Categorical(categories){
...
export const Categorical = function(categories){
  return new _Categorical(categories)
}
...
export const Space = function(dimensions){
  return new _Space(dimensions)
}
 ...
 * objects.
 */
export const to_space = function(space_object){
  // check if list of dimensions
  if(space_object instanceof Array){
    return Space(space_object)
  }
 ...
 */
function _RandomOptimizer(space){
...
export const RandomOptimizer = function(space){
  return new _RandomOptimizer(space)
}
 ...
 * @property {Space} space Optimization space over which the optimization is done.
 */
function _OMGOptimizer(dimensions, n_random_starts = 13, mutation_rate = 0.1) {
...
export const OMGOptimizer = function(dimensions, n_random_starts = 13, mutation_rate = 0.1){
  return new _OMGOptimizer(dimensions, n_random_starts, mutation_rate)
}
 ...
 */
function _dummy_minimize (func, dimensions, n_calls=64){
  var opt = RandomOptimizer(dimensions);
...
export const dummy_minimize = _dummy_minimize
 ...
 */
function _rs_minimize (func, dimensions, n_calls=64, n_random_starts=13, mutation_rate=0.1){
  var opt = OMGOptimizer(
    dimensions,
    n_random_starts,
    mutation_rate
  );
...
export const rs_minimize = _rs_minimize
 ...
 */
export const minimize_Powell = function (fnc, x0) {
  var eps = 0.1;
  ...
  var fx = fnc(x);
  var pidx = 1;
  console.log("MINIMIZE", pfx, alpha, iter)
  while (!convergence && iter < MAX_ITERATIONS) {
 ...
 * value of the function at the best found argument.
 */
export const minimize_GradientDescent = function (fnc, grd, x0) {
 ...
 * value of the function at the best found argument.
 */
export const minimize_L_BFGS = function (fnc, grd, x0) {
  // fnc: function which takes array of size N as an input
  // grd: gradient (array of size N) of function for some input
  // x0: array or real numbers of size N;
  // serves as initialization of algorithm.
...
/*export const numerical_gradient = function (fnc, x) {
